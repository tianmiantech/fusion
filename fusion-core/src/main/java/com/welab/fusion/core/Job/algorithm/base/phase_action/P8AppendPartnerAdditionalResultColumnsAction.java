 ...
 */
package com.welab.fusion.core.Job.algorithm.base.phase_action;
...
public class P8AppendPartnerAdditionalResultColumnsAction<T extends AbstractPsiJob> extends AbstractJobPhaseAction<T> {
    ...
    protected void doAction() throws Exception {
        job.getJobTempData().resultFileWithPartnerAdditionalColumns = super.downloadFileFromPartner("正在从合作方下载附加结果字段..");
    }
