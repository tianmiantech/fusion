...
public class HiveScanner extends JdbcScanner {
    ...
    public HiveScanner(Connection conn, String sql, long maxReadLine) throws SQLException, StatusCodeWithException {
        super(conn, sql, maxReadLine);
    }

    public HiveScanner(Connection conn, String sql, long maxReadLine, List<String> returnFields) throws SQLException, StatusCodeWithException {
