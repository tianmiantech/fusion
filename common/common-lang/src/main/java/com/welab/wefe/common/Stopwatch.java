...
public class Stopwatch {
    ...
    private Stopwatch(String traceId, int maxLabelQueueLength) {
    ...
    public static Stopwatch startNew() {
        ...
        return new Stopwatch(traceId, DEFAULT_LABEL_QUEUE_CAPACITY);
    }

    public static Stopwatch startNew(String traceId) {
        return new Stopwatch(traceId, DEFAULT_LABEL_QUEUE_CAPACITY);
    }
     ...
     */
    public static Stopwatch startNew(String traceId, int maxLabelQueueLength) {
        return new Stopwatch(traceId, maxLabelQueueLength);
    }
