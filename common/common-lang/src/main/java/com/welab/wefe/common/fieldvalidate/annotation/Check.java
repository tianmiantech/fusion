...
public @interface Check {
    ...
    /**
     * 输入内容仅包含一条 sql，禁止包含多条。
     * 且 sql 为 select 语句，禁止发生修改行为。
     */
    boolean oneSelectSql() default false;

    /**
     * 输入内容为一条或多条 sql，且 sql 为 select 语句，禁止发生修改行为。
     */
    boolean multiSelectSql() default false;
}
