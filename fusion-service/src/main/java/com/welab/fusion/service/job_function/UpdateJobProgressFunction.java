 ...
 * @date 2024/1/16
 */
public class UpdateJobProgressFunction implements com.welab.fusion.core.algorithm.base.function.UpdateJobProgressFunction{
    private static final JobService jobService = Launcher.getBean(JobService.class);
    @Override
    public void update(String jobId, JobProgress progress) throws Exception {
